var nameList = [
  ...
  export function generateRandomName() {
   return nameList[Math.floor(Math.random() * nameList.length)];
    ...
    var sentences= [
        'so fat not even Dora can explore her✈️',
        ...
        'so fat she don’t need no internet – she’s already world wide✔️',
